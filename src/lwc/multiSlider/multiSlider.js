/**
 * Created by dominikbarchanski on 20/07/2022.
 */
...
export default class MultiSlider extends LightningElement {
    ...
    @api
    get min(){
        sessionStorage.setItem(this.typeOfData +'-min' , this._min);
    ...
    @api
    get max(){
        sessionStorage.setItem(this.typeOfData +'-max' , this._max);
        return this._max;
    }
    set max(value){
    ...
    set start(value) {
        ...
        this.tmpMin = this.setBoundries(value);
    ...
    set end(value) {
        ...
        this.tmpMax = this.setBoundries( value);
    ...
    onChangeValue() {
        try {
            ...
            sessionStorage.setItem(this.typeOfData + '-min', this.start);
            sessionStorage.setItem(this.typeOfData + '-max', this.end);
        }catch (e){
            console.log(e)
        }
    }
